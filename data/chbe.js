window.registerDepartment("CHBE", {
    ...
    curriculum: [
      ...
      { id: "CHEM113", name: "General Chemistry Lab.", credits: 2, prereqs: ["CHEM112!"], term: 2 },
      { id: "CHEM112", name: "General Chemistry II", credits: 3, prereqs: ["CHEM111", "CHEM113!"], term: 2 },
      ...
      { id: "CHBE386", name: "Math. Modeling in CHBE", credits: 3, prereqs: ["CHBE331!", "CHBE311", "CHBE362!"], term: 6 },
      { id: "CHBE362", name: "Reactor Design", credits: 3, prereqs: ["CHBE213", "CHBE386!"], term: 6 },
